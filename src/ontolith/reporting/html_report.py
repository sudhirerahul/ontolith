...
<title>Ontolith — Release Report {{ run_id }}</title>
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .verdict-PASS  { background: rgba(12,163,12,0.15); color: var(--pass); border: 2px solid var(--pass); }
  .verdict-WARN  { background: rgba(250,178,25,0.15); color: var(--warn); border: 2px solid var(--warn); }
  .verdict-BLOCK { background: rgba(208,59,59,0.15); color: var(--block); border: 2px solid var(--block); }
  ...
  .tag-pass  { background: rgba(12,163,12,0.15); color: var(--pass); }
  .tag-fail  { background: rgba(208,59,59,0.15); color: var(--block); }
  .tag-warn  { background: rgba(250,178,25,0.15); color: var(--warn); }
  .tag-block { background: rgba(208,59,59,0.15); color: var(--block); }
