...
Required env vars:
  AZURE_OPENAI_ENDPOINT   https://callguardtest-resource.openai.azure.com
...
class FoundryAgentCore:
    def __init__(self, version: str = "foundry-callguard-v2") -> None:
        self.version = version
        self.endpoint = os.environ.get(
            "AZURE_OPENAI_ENDPOINT",
            "https://callguardtest-resource.openai.azure.com"
        ).rstrip("/")
    ...
    def _call(self) -> str:
        ...
        try:
            with urllib.request.urlopen(req, timeout=30) as resp:
                ...
                # Capture tool calls so CallGuard evaluators can see them
